  ...
  return (
    ...
    <div className="grid w-full grid-cols-1 -mt-40 md:-mt-60 md:grid-cols-2">
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-white right-10 bottom-20">Two Bear Hoodie</h1>
        <h1 className="absolute text-sm text-white right-10 bottom-14">£39.99</h1>
      </Link>
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-green-800 right-10 bottom-24">Cyclist Hoodie</h1>
        <h1 className="absolute text-sm text-green-800 right-10 bottom-20">£39.99</h1>
      ...
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-green-800 right-10 bottom-24">Blue Socrates Hoodie</h1>
        <h1 className="absolute text-sm text-green-800 right-10 bottom-20">£39.99</h1>
      ...
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-green-800 right-10 bottom-24">Black Socrates Hoodie</h1>
        <h1 className="absolute text-sm text-green-800 right-10 bottom-20">£39.99</h1>
      ...
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-green-800 right-10 bottom-24">Blue Plane Hoodie</h1>
        <h1 className="absolute text-sm text-green-800 right-10 bottom-20">£39.99</h1>
      ...
      <Link onClick={scrollToTop} to="/planthoodie" className="relative">
        ...
        <h1 className="absolute text-sm text-green-800 right-10 bottom-24 ">Two Bear Hoodie</h1>
        <h1 className="absolute text-sm text-green-800 right-10 bottom-20 ">£39.99</h1>
      </Link>
