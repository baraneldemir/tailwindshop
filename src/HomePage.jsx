...
export default function HomePage() {
    return (
        <>
            <div className="flex-auto relative bg-emerald-50">

                <div className="-mt-20 top-0 bottom-auto left-0 right-0 w-full absolute" style={{ height: "80px" }}>
                    <svg className="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0">
                        <polygon className=" text-emerald-50 fill-current" points="2560 0 2560 150 0 100">
                        </polygon>
                    </svg>
                </div>
                ...
                {/* <div className="-mb-21 bottom-0 top-auto left-0 right-0 w-full absolute" style={{height:"80px"}}>
                <svg className="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0">
            ...
            <section className="mt-40 pb-5 relative bg-gray-100">
                <div className="-mt-20 top-0 bottom-auto left-0 right-0 w-full absolute" style={{ height: "80px" }}>
                    <svg className="absolute bottom-0 overflow-hidden" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" version="1.1" viewBox="0 0 2560 100" x="0" y="0">
                        ...
                        <div className="w-12/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
                            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-2xl rounded-lg bg-green-100">
                                ...
                                <blockquote className="relative p-8 mb-4">
                                    ...
                                    <p className="text-sm font-light mt-2 text-black">Creating your eco-friendly wardrobe has never been easier. Mix and match from our thoughtfully designed collections. From casual styles to cozy essentials, you can easily find and customize your perfect hoodie for any occasion.</p>
                                </blockquote>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-wrap">
                                <div className="w-full md:w-6/12 px-4">
                                    ...
                                    <div className="relative flex flex-col mt-4 min-h-[300px]">
                                        ...
                                        <div className="w-auto h-full mb-10 md:w-40 md:h-full lg:w-56 lg:h-full bg-white">
                                                <img src={bej4} alt="..." />
                                            </div>
                                            <hr className=" rounded-full my-6 border-4 border-emerald-300"></hr> 
                                            <h6 className="text-2xl mb-1 font-semibold">Eco-Friendly Materials</h6>
                                            <p className="text-sm mb-4 text-blueGray-500">Our hoodies are crafted from sustainably sourced, plant-based fibers, ensuring comfort and environmental responsibility.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex flex-col min-w-0 min-h-[300px]">
                                        ...
                                        <div className="w-auto h-full mb-10 md:w-40 md:h-full lg:w-56 lg:h-full bg-white">
                                            ...
                                            <hr className=" rounded-full my-6 border-4 border-emerald-300"></hr> 
                                            <h6 className="text-2xl mb-1 font-semibold">Innovative Designs</h6>
                                            <p className="text-sm mb-4 text-blueGray-500">Discover our collection of stylish and functional hoodies that feature eco-conscious designs perfect for any occasion.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="w-full md:w-6/12 px-4">
                                    ...
                                    <div className="relative flex flex-col min-w-0 mt-4 min-h-[300px]">
                                        <div className="px-4 py-5 flex-auto">
                                            ...
                                            <hr className=" rounded-full my-6 border-4 border-emerald-300"></hr> 
                                            <h6 className="text-2xl mb-1 font-semibold">Shop Our Collection</h6>
                                            <p className="text-sm mb-4 text-blueGray-500">Explore our fully curated collection with detailed descriptions, so you can find the perfect hoodie that aligns with your values.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex flex-col min-w-0 min-h-[300px]">
                                        <div className=" px-4 py-5 flex-auto">
                                            ...
                                            <hr className=" rounded-full my-6 border-4 border-emerald-300"></hr> 
                                            <h6 className="text-2xl mb-1 font-semibold">Sustainability Promise</h6>
                                            <p className="text-sm mb-4 text-blueGray-500">Designed by eco-conscious innovators for nature lovers. You'll love how easy it is to embrace sustainability with our plant-based hoodie collection.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
