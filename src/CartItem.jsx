  ...
  return (
    ...
    <div class="rounded-lg border h-40 border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div class="space-y-4 flex items-center md:justify-between md:gap-6 md:space-y-0">
              ...
              <div class="flex items-center justify-between order-3 md:justify-end">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">{item.price * quantity}</p>
                </div>
              </div>
              ...
              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <button onClick={()=> removeFromCart(item.id)} class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                    <svg class="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
